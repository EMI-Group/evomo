...
import torch
import inspect
from evomo.problems.constrained import *
...
class TestConstrainedProblems(TestCase):
    ...
    def test_ctp(self):
        self._run_test_suite([CTP1, CTP2, CTP3, CTP4, CTP5, CTP6, CTP7, CTP8])

    def test_dascmop(self):
        self._run_test_suite([
            DASCMOP1, DASCMOP2, DASCMOP3, DASCMOP4, DASCMOP5, 
    ...
    def test_fcp(self):
        self._run_test_suite([FCP1, FCP2, FCP3, FCP4, FCP5])
    ...
    def test_lscm(self):
        self._run_test_suite([
            LSCM1, LSCM2, LSCM3, LSCM4, LSCM5, LSCM6, 
            LSCM7, LSCM8, LSCM9, LSCM10, LSCM11, LSCM12
        ])

    def test_mw(self):
        self._run_test_suite([
            MW1, MW2, MW3, MW4, MW5, MW6, MW7, 
            MW8, MW9, MW10, MW11, MW12, MW13, MW14
        ])
