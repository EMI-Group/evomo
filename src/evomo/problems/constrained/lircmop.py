...
class LIRCMOP5(LIRCMOP):
    def __init__(
        self, d: int = 30, m: int = 2, n_iq: int = 2, ref_num: int = 1000, cons_params: Optional[torch.Tensor] = None, **kwargs
    ):
        super().__init__(d=d, m=m, n_iq=n_iq, ref_num=ref_num, **kwargs)
...
class LIRCMOP9(LIRCMOP5):
    ...
    def pf(self):
        ...
        endpoints = torch.tensor([[0.0, 2.182], [1.856, 0.0]], dtype=pf.dtype, device=pf.device)
...
class LIRCMOP13(LIRCMOP):
    def __init__(
        self, d: int = 30, m: int = 3, n_iq: int = 2, ref_num: int = 1000, cons_params: Optional[torch.Tensor] = None, **kwargs
    ):
        super().__init__(d=d, m=m, n_iq=n_iq, ref_num=ref_num, **kwargs)
